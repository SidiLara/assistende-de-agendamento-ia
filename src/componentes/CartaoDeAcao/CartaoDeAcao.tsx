...
export const CartaoDeAcao: React.FC<CartaoDeAcaoProps> = ({ titulo, linkPara, icone }) => {
    return (
        <ReactRouterDOM.Link to={linkPara} className="group block bg-white dark:bg-dark-secondary rounded-lg shadow-md p-6 border border-gray-200 dark:border-slate-700 transition-all duration-300 hover:shadow-xl hover:border-brand-blue hover:-translate-y-1">
