    ...
    if (isNotice) {
        return (
            <div className="flex items-center justify-center my-2 animate-message">
                <div className="flex items-center space-x-3 max-w-md bg-yellow-100 dark:bg-yellow-900/50 border border-yellow-200 dark:border-yellow-800 text-yellow-800 dark:text-yellow-200 rounded-lg p-3 text-sm">
